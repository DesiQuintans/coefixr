...
- [Worked example](#worked-example)
      + [Automated calculation with `adjust_interaction_model()`](#automated-calculation-with-adjust_interaction_model)
- [Details re. the calculations performed](#details-re-the-calculations-performed)
   * [Adjusted interaction coefficients](#adjusted-interaction-coefficients)
